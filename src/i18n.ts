...
const STRINGS = {
  en: {
    ...
    "settings.nav.claude": "API Keys",
    "settings.nav.collaborators": "Collaborators",
    "settings.disconnectApi": "Disconnect API",
  ...
  es: {
    ...
    "settings.nav.claude": "API Keys",
    "settings.nav.collaborators": "Colaboradores",
    "settings.disconnectApi": "Desconectar API",
    "settings.nav.magnific": "Magnific (MCP)",
